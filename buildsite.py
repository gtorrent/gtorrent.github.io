...
def main():
    if os.path.isdir(os.path.join(os.getcwd(), "site")):
        shutil.rmtree(os.path("site"))
    if not os.path.isdir(os.path.join(os.getcwd(), "site")):
        os.mkdir("site")
    shutil.copytree("css", os.path.join("site", "css"))
    shutil.copytree("fonts", os.path.join("site", "fonts"))
    shutil.copytree("images", os.path.join("site", "images"))
    shutil.copytree("js", os.path.join("site", "js"))
